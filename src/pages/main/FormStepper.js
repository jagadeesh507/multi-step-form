  ...
  return (
      <Flex justify={"center"} pt={{base:"50px",md:"20px"}}>
        ...
        <div  key={i} className='flex flexDirection-row gap-4 items-center'>
            <div className={`${state===i+1?"bg-blue-400":state===5?"bg-blue-400":"bg-gray "} w-8 h-8 flex items-center justify-center rounded-full font-semibold text-white border border-blue-400 border-[2px] `}>{i+1}</div>
